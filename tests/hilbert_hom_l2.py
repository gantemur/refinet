...
from refinet.geometry.library import create_hilbert_homogeneous, initial_unit_segment
...
def main():
    ...
    system = create_hilbert_homogeneous()
    ...
    n_depth = 5  # Depth 6 yields 4096 line segments (4^6)
    num_points = 4097
    ...
    plt.axis('equal')
    plt.axis('off') 
    plt.title(f"Homogeneous Hilbert (Level 2 Exact Algebra) - Depth {n_depth}")
    
    output_filename = "hilbert_homogeneous_level2.png"
