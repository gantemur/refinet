...
from refinet.geometry.library import create_peano

def main():
    n_depth = 3 # Try changing this to 2, 3, or 4
    
    system, Gamma_n = create_peano()
    ...
    plt.title(f"Peano (Infinite Finite-Span) - Depth {n_depth}")
    
    output_filename = f"peano_infinite_level2_d{n_depth}.png"
